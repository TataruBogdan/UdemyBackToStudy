...
/* other functions that you might be initializing
* the memory and do all sorts of other things. */

public class Main {

    private static Scanner scanner = new Scanner(System.in);

    private static MobilePhone mobilePhone = new MobilePhone("1234 098 798");
    ...
    private static void updateContact(){
        ...
        if(mobilePhone.updateContact(existingContactRecord, contact)){
            System.out.println("Successfully upload record.");
        } else {
    ...
    private static void printActions(){
        System.out.println("\nAvailable actions\npress");
        System.out.println("0 - to shutdoun\n" +
                            "1 - to print contacts\n" +
